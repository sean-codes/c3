    ...
    <script type="module">
      ...
      function createRagdoll(scale, position, world, angleA, angleB, twistAngle) {
        ...
        var headShape = new CANNON.Sphere(headRadius),
          ...
          upperBodyShape = new CANNON.Box(
            new CANNON.Vec3(shouldersDistance * 0.5, upperBodyLength * 0.5, lowerArmSize * 0.5)
          ),
          pelvisShape = new CANNON.Box(
            new CANNON.Vec3(shouldersDistance * 0.5, pelvisLength * 0.5, lowerArmSize * 0.5)
          ),
