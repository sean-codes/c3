...
<html>
  ...
  <body>
    <div id="info"><a href="http://github.com/schteppe/cannon.js">Cannon.js</a> voxel landscape example</div>
    ...
    <script type="module">
        ...
        for (var i = 0; i < nx; i++) {
          for (var j = 0; j < ny; j++) {
            for (var k = 0; k < nz; k++) {
              ...
              if (Math.sin(i * 0.1) * Math.sin(k * 0.1) < (j / ny) * 2 - 1) filled = false
      ...
      function init() {
        ...
        light = new THREE.SpotLight(0xffffff, 0.7, 0, Math.PI / 4, 1)
