...
import { Geometry, Face3 } from '../three-geometry/Geometry.js'
// Cannon Debugger
   ...
   constructor(scene, world, options) {
    ...
    _createMesh(shape){
        ...
        case CANNON.Shape.types.CONVEXPOLYHEDRON:
            ...
            mesh = new THREE.Mesh(geo.toBufferGeometry(), material);
        ...
        case CANNON.Shape.types.TRIMESH:
            ...
            mesh = new THREE.Mesh(geometry.toBufferGeometry(), material);
